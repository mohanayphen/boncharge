...
export const products: Product[] = [
  ...
  {
    id: "kids-blue-light-glasses",
    title: "Kids Blue Light Glasses",
    subtitle: "Screen Time Protection",
    category: "Glasses",
    tags: ["Blue Light", "Kids", "Screen Time", "For Kids"],
    price: 49,
    compareAtPrice: 69,
    rating: 4.9,
    reviewsCount: 334,
    image: "/images/13.png",
    badge: "New",
    shortBenefit: "Protect young eyes from harmful blue light",
    description: "Specially designed blue light glasses for children with comfortable, durable frames and effective blue light filtering.",
    features: [
